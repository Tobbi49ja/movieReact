...
export default function Navbar() {
  ...
  const handleNavClick = (path) => {
    if (location.pathname === path) {
      // If already on this page → scroll to top and refresh
    ...
    <header>
      ...
      <nav id="nav-menu" className={navOpen ? "active" : ""}>
        <ul>
          ...
          <li><Link to="/movies" onClick={() => handleNavClick("/movies")}>movies</Link></li>
          <li><Link to="/tvshows" onClick={() => handleNavClick("/tvshows")}>tv shows</Link></li>

          <li className="relative">
            <a href="#" onClick={toggleGenres}>genres</a>
            <div
