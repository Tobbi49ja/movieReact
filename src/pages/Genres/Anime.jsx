  ...
  return (
    <main className="pulldown">
      ...
      <MoviesFetch
        ...
        apiUrl={`https://api.themoviedb.org/3/discover/tv?api_key=${API_KEY}&language=en-US&with_original_language=ja&sort_by=popularity.desc`}
      />

      <MoviesFetch
        title="Popular Anime Movies"
        apiUrl={`https://api.themoviedb.org/3/discover/movie?api_key=${API_KEY}&language=en-US&with_original_language=ja&sort_by=popularity.desc`}
      />
    </main>
  );
}
